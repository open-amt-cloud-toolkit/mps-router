...
// func TestGetMPSInstancewithInvalidGUID(t *testing.T) {
// 	db, err := connectToDB("postgresql://")
// 	assert.NotNil(t, err, "test failed to connect db")
// 	_, err = getMPSInstance(db, "d12428be-9fa1-4226-9784&port=16994")
